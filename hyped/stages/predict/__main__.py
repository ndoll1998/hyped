...
parser = ArgumentParser("prepare", description="Apply model on prepared datasets")
...
parser.add_argument("-d", "--data", type=str, required=True, help="Paths to prepared data dumps")
...
parser.add_argument("-o", "--out-dir", type=str, default=None, help="Output directory, by default saves dataset with predictions in checkpoint")
