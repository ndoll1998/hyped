...
class CoveredIndexSpansConfig(BaseDataProcessorConfig):
    ...
    # query spans
    queries_begin: str = None
    queries_end: str = None
    # span sequence
...
class CoveredIndexSpans(BaseDataProcessor[CoveredIndexSpansConfig]):
    ...
    def map_features(self, features: Features) -> Features:
        ...
        raise_feature_exists(self.config.queries_begin, features)
        raise_feature_exists(self.config.queries_end, features)
        ...
        for key in [self.config.queries_begin, self.config.queries_end]:
            if not (
        ...
        raise_features_align(
            ...
            features[self.config.queries_begin],
            features[self.config.queries_end],
        )
    ...
    def process(
        ...
        """
        # get query spans
        queries_begin = example[self.config.queries_begin]
        queries_end = example[self.config.queries_end]
